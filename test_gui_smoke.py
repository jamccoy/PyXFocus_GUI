...
def test_show_script_actually_runs():
    ...
    designs = [
        ...
        ('curved detector', WolterParams(num_rays=2000, seed=7, use_grating=1,
                                         grating_order_span=2, use_detector=1,
                                         det_shape=1, det_radius=200.)),
        ('sized + both tilts', WolterParams(num_rays=2000, seed=7,
                                            use_detector=1, det_size=40.,
                                            det_tilt=1.5, det_tilt_y=2.5)),
        ('curved, sized, fanned', WolterParams(num_rays=2000, seed=7,
                                               use_grating=1,
                                               grating_order_span=2,
                                               use_detector=1, det_shape=1,
                                               det_radius=200., det_size=40.)),
